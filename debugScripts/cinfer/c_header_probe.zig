...
// Debug helper: replace {{HEADER}} and {{SYMBOLS}} (one per line, quoted, comma).
// Example:
//   {{HEADER}} -> C:/GIT/workman/examples/raylib/wm/raylib.h
//   {{SYMBOLS}} ->
//     "SetTargetFPS",
//     "InitWindow",
//
// Then run:
//   zig run debugScripts/cinfer/c_header_probe.zig
